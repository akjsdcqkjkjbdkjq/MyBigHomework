        ...
        if (k >= 0 && k <= 3) {
            ...
            if (history[1] == g % 4) {
                if (clock == 3 && history[2] == (g + 3) % 4) {
                    play((g + 1) % 4 + 4);
                } else if (clock == 3 && (history[2] == (g + 3) % 4 + 4 || history[2] == (g + 2) % 4)) {
                    play((g + 1) % 4);
                } else if (clock == 3 && history[2] == 8) {
                    play((g + 2) % 4 + 4);
                } else if (clock == 3 && (history[2] == (g + 2) % 4 + 4 || history[2] == (g + 1) % 4 + 4 || history[2] == (g + 1) % 4)) {
                    play(8);
                }
                if (history[3] == (g + 1) % 4 + 4) {
                    if (clock == 5 && history[4] != (g + 1) % 4) {
                        play((g + 1) % 4);
                    } else if (clock == 5 && history[4] == (g + 1) % 4) {
                        play(8);
                    }
                    if (clock == 7 && history[6] == (g + 2) % 4) {
                        play((g + 3) % 4 + 4);
                    } else if (clock == 7 && history[6] == (g + 3) % 4 + 4) {
                        play((g + 2) % 4);
                    } else if (clock == 7 && history[6] != (g + 2) % 4 && history[6] != (g + 3) % 4 + 4) {
                        int i = randint() % 2;
                        switch (i) {
                            case 0:
                                play((g + 2) % 4);
                    ...
                    if (history[5] == (g + 1) % 4) {
                        if (history[4] == (g + 2) % 4) {
                            ...
                            if (clock == 7 && history[6] != (g + 1) % 4 + 4 && history[6] != (g + 2) % 4) {
                                int i = randint() % 2;
                                switch (i) {
                                    case 0:
                                        play((g + 2) % 4);
                    ...
                    if (history[2] == (g + 3) % 4 + 4) {
                        if (clock == 7 && history[6] != (g + 3) % 4 && history[6] != (g + 2) % 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g + 3) % 4);
                    ...
                    if (clock == 5 && history[4] != (g + 2) % 4) {
                        play((g + 2) % 4);
                    } else if (clock == 5 && history[4] == (g + 2) % 4 && history[2] == (g + 2) % 4 + 4) {
                        play((g + 1) % 4);
                    } else if (clock == 5 && history[4] == (g + 2) % 4 && history[2] == (g + 1) % 4) {
                        play((g + 2) % 4 + 4);
                    } else if (clock == 5 && history[4] == (g + 2) % 4 && history[2] == (g + 1) % 4 + 4) {
                        int i = randint() % 4;
                        switch (i) {
                            case 0:
                                play((g + 3) % 4);
                    ...
                    if (history[5] == (g + 1) % 4) {
                        ...
                        if (clock == 7 && history[6] == (g + 3) % 4) {
                            ...
                            play((g + 3) % 4);
                        } else if (clock == 7 && history[6] != (g + 3) % 4 && history[6] != (g + 3) % 4 + 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g + 3) % 4);
                        ...
                        if (clock == 7 && history[6] == (g + 2) % 4 + 4) {
                            play((g + 1) % 4);
                        } else if (clock == 7 && history[6] == (g + 1) % 4) {
                            play((g + 2) % 4 + 4);
                        } else if (clock == 7 && history[6] != (g + 1) % 4 && history[6] != (g + 2) % 4 + 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g + 1) % 4);
            ...
            } else if (history[1] == (g + 3) % 4) {
                if (clock == 3 && history[2] == g % 4) {
                    play((g + 3) % 4 + 4);
                } else if (clock == 3 && (history[2] == (g + 1) % 4 + 4 || history[2] == (g + 1) % 4)) {
                    play((g + 2) % 4);
                } else if (clock == 3 && history[2] == 8) {
                    play((g + 2) % 4 + 4);
                } else if (clock == 3 && (history[2] == (g + 2) % 4 + 4 || history[2] == (g + 3) % 4 + 4 || history[2] == (g + 2) % 4)) {
                    play(8);
                }
                if (history[3] == (g + 3) % 4 + 4) {
                    ...
                    if (clock == 7 && history[6] == (g + 1) % 4) {
                        ...
                        play((g + 1) % 4);
                    } else if (clock == 7 && history[6] != (g + 1) % 4 && history[6] != (g + 1) % 4 + 4) {
                        int i = randint() % 2;
                        switch (i) {
                            case 0:
                                play((g + 1) % 4);
                    ...
                    if (history[5] == (g + 2) % 4) {
                        if (history[4] == (g + 1) % 4) {
                            if (clock == 7 && history[6] != (g + 3) % 4 + 4) {
                                play((g + 3) % 4 + 4);
                            } else if (clock == 7 && history[6] == (g + 3) % 4 + 4) {
                                play((g + 1) % 4 + 4);
                            }
                        } else {
                            if (clock == 7 && history[6] != (g + 3) % 4 + 4 && history[6] != (g + 1) % 4) {
                                int i = randint() % 2;
                                switch (i) {
                                    case 0:
                                        play((g + 1) % 4);
                        ...
                        } else if (clock == 7 && history[6] == (g) % 4) {
                            play((g + 2) % 4);
                        } else if (clock == 7 && history[6] == (g + 2) % 4) {
                            play((g) % 4);
                        }
                    } else if (history[5] == (g) % 4) {
                        if (clock == 7 && history[6] == (g + 1) % 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                    ...
                    if (clock == 5 && history[4] != (g + 3) % 4 + 4) {
                        play((g + 3) % 4 + 4);
                    } else if (clock == 5 && history[4] == (g + 3) % 4 + 4) {
                        play(8);
                    }
                    if (history[2] == (g + 1) % 4 + 4) {
                        if (clock == 7 && history[6] != (g + 3) % 4 && history[6] != (g + 1) % 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g) % 4);
                    ...
                    } else if (history[2] == (g + 1) % 4) {
                        if (clock == 7 && history[6] != (g) % 4) {
                            play((g) % 4);
                        } else if (clock == 7 && history[6] == (g) % 4) {
                            play((g + 1) % 4 + 4);
                        }
                    ...
                    if (clock == 5 && history[4] != (g + 1) % 4) {
                        play((g + 1) % 4);
                    } else if (clock == 5 && history[4] == (g + 1) % 4 && history[2] == (g + 2) % 4 + 4) {
                        play((g + 2) % 4);
                    } else if (clock == 5 && history[4] == (g + 1) % 4 && history[2] == (g + 2) % 4) {
                        play((g + 2) % 4 + 4);
                    } else if (clock == 5 && history[4] == (g + 1) % 4 && history[2] == (g + 3) % 4 + 4) {
                        int i = randint() % 4;
                        switch (i) {
                            case 0:
                                play((g) % 4);
                    ...
                    if (history[5] == (g + 2) % 4) {
                        ...
                        if (clock == 7 && history[6] == (g) % 4) {
                            ...
                            play((g) % 4);
                        } else if (clock == 7 && history[6] != (g) % 4 && history[6] != (g + 1) % 4 + 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g) % 4);
                        ...
                        if (clock == 7 && history[6] == (g + 2) % 4 + 4) {
                            ...
                            play((g + 2) % 4 + 4);
                        } else if (clock == 7 && history[6] != (g + 2) % 4 && history[6] != (g + 2) % 4 + 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g + 2) % 4);
                ...
                if (history[3] == g % 4) {
                    if (clock == 5 && history[4] != (g + 2) % 4) {
                        ...
                        if (clock == 5 && history[2] == (g + 3) % 4 + 4) {
                            play((g + 3) % 4);
                        } else if (clock == 5 && history[2] == (g + 3) % 4) {
                            play((g + 3) % 4 + 4);
                        } else if (clock == 5 && history[2] == (g + 2) % 4 + 4) {
                            play((g + 1) % 4);
                        } else if (clock == 5 && history[2] == (g + 1) % 4) {
                            play((g + 2) % 4 + 4);
                        } else if (clock == 5 && history[2] == (g + 1) % 4 + 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g + 3) % 4);
                    ...
                    if (clock == 5 && history[4] != (g + 3) % 4 + 4) {
                        ...
                        if (clock == 5 && history[2] == (g + 2) % 4) {
                            play((g + 3) % 4);
                        } else if (clock == 5 && (history[2] == (g + 2) % 4 + 4 || history[2] == (g + 1) % 4)) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g + 3) % 4);
                    ...
                    if (history[5] == (g + 3) % 4) {
                        if (clock == 7 && history[2] == (g + 2) % 4 && history[6] != (g + 1) % 4) {
                            play((g + 1) % 4);
                        } else if (clock == 7 && history[2] == (g + 2) % 4 && history[6] == (g + 1) % 4) {
                            play((g + 2) % 4 + 4);
                        } else if (clock == 7 && history[2] == (g + 2) % 4 + 4 && history[6] != (g + 1) % 4) {
                            play((g + 1) % 4);
                        } else if (clock == 7 && history[2] == (g + 2) % 4 + 4 && history[6] == (g + 1) % 4) {
                            play((g + 2) % 4);
                        } else if (clock == 7 && history[2] == (g + 1) % 4 && history[6] == (g + 2) % 4) {
                            play((g + 2) % 4 + 4);
                        } else if (clock == 7 && history[2] == (g + 1) % 4 && history[6] == (g + 2) % 4 + 4) {
                            play((g + 2) % 4);
                        } else if (clock == 7 && history[2] == (g + 1) % 4 && history[6] == (g) % 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g + 2) % 4);
                ...
                } else if (history[3] == (g + 3) % 4 + 4) {
                    if (clock == 5 && history[4] != (g + 1) % 4 + 4) {
                        play((g + 1) % 4 + 4);
                    } else {
                        if (clock == 5 && history[2] == (g + 1) % 4) {
                            play((g) % 4);
                        } else if (clock == 5 && (history[2] == (g + 2) % 4 + 4 || history[2] == (g + 2) % 4)) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g) % 4);
                    ...
                    if (history[5] == (g) % 4) {
                        if (clock == 7 && history[2] == (g + 1) % 4 && history[6] != (g + 2) % 4) {
                            play((g + 2) % 4);
                        } else if (clock == 7 && history[2] == (g + 1) % 4 && history[6] == (g + 2) % 4) {
                            play((g + 2) % 4 + 4);
                        } else if (clock == 7 && history[2] == (g + 2) % 4 + 4 && history[6] != (g + 2) % 4) {
                            play((g + 2) % 4);
                        } else if (clock == 7 && history[2] == (g + 2) % 4 + 4 && history[6] == (g + 2) % 4) {
                            play((g + 1) % 4);
                        } else if (clock == 7 && history[2] == (g + 2) % 4 && history[6] == (g + 1) % 4) {
                            play((g + 2) % 4 + 4);
                        } else if (clock == 7 && history[2] == (g + 2) % 4 && history[6] == (g + 2) % 4 + 4) {
                            play((g + 1) % 4);
                        } else if (clock == 7 && history[2] == (g + 2) % 4 && history[6] == (g + 3) % 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g + 1) % 4);
                    ...
                    if (clock == 5 && history[4] != (g + 1) % 4) {
                        ...
                        if (clock == 5 && history[2] == (g + 1) % 4 + 4) {
                            play((g) % 4);
                        } else if (clock == 5 && history[2] == (g) % 4) {
                            play((g + 1) % 4 + 4);
                        } else if (clock == 5 && history[2] == (g + 2) % 4 + 4) {
                            play((g + 2) % 4);
                        } else if (clock == 5 && history[2] == (g + 2) % 4) {
                            play((g + 2) % 4 + 4);
                        } else if (clock == 5 && history[2] == (g + 3) % 4 + 4) {
                            int i = randint() % 2;
                            switch (i) {
                                case 0:
                                    play((g) % 4);
